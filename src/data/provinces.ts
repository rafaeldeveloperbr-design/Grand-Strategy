/**
 * ============================================================
 * MÓDULO 1 - Definição das Províncias
 * ============================================================
 * Contém os dados de todas as províncias no mapa.
 * Cada província possui um path SVG, vizinhos, e propriedades.
 * 
 * O mapa é dividido em regiões que formam um continente fictício.
 * As províncias são organizadas em grid para facilitar visualização.
 */

import { Province } from '../types';

/**
 * Dados brutos das províncias.
 * Os paths SVG formam um mapa contínuo sem sobreposições.
 */
export const provincesData: Province[] = [
  // === IMPÉRIO AURELIANO (Norte-Central) ===
  {
    id: 'p1',
    name: 'Capitalis Aurea',
    owner: 'IMP',
    color: '#8B0000',
    neighbors: ['p2', 'p6', 'p10'],
    population: 45000,
  ...
  // === REPÚBLICA DE VALÓRIA (Leste) ===
  {
    id: 'p6',
    name: 'Valoria Prima',
    owner: 'REP',
    color: '#1E3A8B',
    neighbors: ['p1', 'p7', 'p10', 'p12'],
    population: 32000,
    center: { x: 180, y: 260 },
  ...
  },
  {
    ...
    owner: 'REP',
    color: '#1E3A8B',
    neighbors: ['p5', 'p8', 'p16', 'p18'],
    population: 18000,
    center: { x: 370, y: 400 },
    path: 'M340,340 L450,350 L440,410 L430,450 L320,440 L330,400 Z',
  },
  // === REINO DE NORDHEIM (Oeste) ===
  {
    id: 'p10',
    name: 'Nordheim Capitalis',
    owner: 'RNO',
    color: '#1B5E20',
    neighbors: ['p1', 'p6', 'p11'],
    population: 30000,
  ...
  {
    id: 'p13',
    name: 'Fjord Profundis',
    owner: 'RNO',
    color: '#1B5E20',
    neighbors: ['p7', 'p12', 'p17'],
    population: 8000,
    center: { x: 60, y: 380 },
  ...
  {
    id: 'p16',
    name: 'Portus Orientalis',
    owner: 'KHA',
    color: '#F57F17',
    neighbors: ['p5', 'p9', 'p15', 'p18'],
    population: 25000,
    center: { x: 570, y: 370 },
